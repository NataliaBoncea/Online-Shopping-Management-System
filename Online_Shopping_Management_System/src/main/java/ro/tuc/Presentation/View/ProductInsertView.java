 ...
 * @Since: May 18, 2023
 */
public class ProductInsertView extends JFrame {
    ...
    private JButton insertButton = new JButton("Adauga");
    ...
    public ProductInsertView(ProductView productView) {
        ...
        insertButton.setBackground(bg_color);
