...
public class ClientView extends JFrame{
    ...
    private JButton insertButton = new JButton("Client nou");
    private JButton deleteButton = new JButton("Sterge client");
    private JButton updateButton = new JButton("Modifica client");
    private String columnNames[] = {"ID", "NUME", "PRENUME", "ADRESA", "EMAIL", "NR. TELEFON"};
    public DefaultTableModel model  = new DefaultTableModel();
    private JTable clientTable = new JTable(model);
    ...
    public ClientView(){
        ...
        reflectionClient.setTable(clientList, model);
        clientTable.setPreferredScrollableViewportSize(new Dimension(700, 100));
        clientTable.getColumnModel().getColumn(0).setPreferredWidth(10);
        clientTable.getColumnModel().getColumn(1).setPreferredWidth(70);
        clientTable.getColumnModel().getColumn(2).setPreferredWidth(120);
        clientTable.getColumnModel().getColumn(3).setPreferredWidth(170);
        clientTable.getColumnModel().getColumn(4).setPreferredWidth(170);
        p2.add(new JScrollPane(clientTable));
    ...
    public int getSelectedId(){
        ...
        return Integer.parseInt((String)clientTable.getValueAt(row, 0));
    }
